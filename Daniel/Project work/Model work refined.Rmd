...
preds.logmod <- predict(logmod, newdata = testing, type = "response")
preds.logmod.lasso <- predict(logmod.lasso, newdata = testing, type = "response")
actual<-testing$target

normalizedGini(preds.logmod,actual)
```
